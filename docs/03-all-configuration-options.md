...
| <a id="config-opt-server-favicon"></a>`server.favicon` | string | URL of the favicon for the app.<br>This must be an ICO, PNG, or SVG file, and it's fetched when the server starts up.|  |
